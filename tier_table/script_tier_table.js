...
const buffedChars = ["채찍 라우라","방망이 루크","기타 르노어","채찍 마이","저격총 버니스","도끼 아비게일","VF의수 에키온","석궁 유스티나","창 이슈트반","레이피어 카밀로","쌍검 카밀로","단검 캐시","쌍검 캐시","도끼 케네스","레이피어 키아라","창 펠릭스","톤파 현우"];
const nerfedChars = ["방망이 다르코","양손검 데비&마를렌","권총 레니","아르카나 샬럿","권총 실비아","권총 아야","톤파 알렉스","아르카나 요한","아르카나 유민","권총 제니"];
const adjustedChars = ["레이피어 엘레나",];
// -------------------------------------------------------------
