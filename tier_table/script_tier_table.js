...
const buffedChars = ["방망이 가넷","권총 니아","채찍 라우라","채찍 레녹스","권총 레니","글러브 레온","권총 로지","방망이 루크","기타 르노어","글러브 리 다이린","쌍절곤 리 다이린","도끼 마커스","망치 마커스","방망이 매그너스","망치 매그너스","권총 바바라","저격총 버니스","투척 셀린","단검 쇼우","창 쇼우","방망이 수아","방망이 아델라","아르카나 아디나","도끼 아비게일","권총 아야","저격총 아야","권총 아이솔","돌격 소총 아이솔","글러브 알론소","도끼 에스텔","레이피어 엘레나","암기 츠바메","석궁 칼라","암기 클로에","저격총 테오도르","기타 프리야","쌍절곤 피올로"];
const nerfedChars = ["글러브 니키","양손검 데비&마를렌","석궁 유스티나","투척 이렘","암기 자히르",,"암기 타지아","레이피어 피오라"];
const adjustedChars = [""];
// -------------------------------------------------------------
