...
const buffedChars = ["방망이 가넷","활 나딘","석궁 나딘","단검 다니엘","채찍 마이","권총 바바라","아르카나 비앙카","투척 아드리아나","글러브 알론소","아르카나 요한","단검 이안","암기 자히르","암기 츠바메","도끼 케네스","암기 클로에","저격총 테오도르","돌격 소총 헤이즈"];
const nerfedChars = ["카메라 나타폰","권총 니아","글러브 니키","글러브 레온","톤파 레온","아르카나 바냐","아르카나 샬럿","단검 쇼우","창 쇼우","아르카나 아르다","투척 윌리엄","쌍검 유키","양손검 유키","투척 자히르","저격총 카티야"];
const adjustedChars = [""];
// -------------------------------------------------------------
